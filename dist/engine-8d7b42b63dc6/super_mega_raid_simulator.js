...
export function createRaidEngine(input, catalog) {
    ...
    class TrialResult {
        ...
        rejoins;
        catch_tanks_used;
        constructor(won, finish_time, boss_hp, switches, faints, tactical_switches, rejoins, catch_tanks_used) {
            this.won = won;
    ...
    class Simulation {
        ...
        replay_sequence;
        current_time;
        constructor(boss_fast, boss_charged, rng, dodge_profiles = null, boss_hp = BOSS_HP, boss_energy = 0.0, enraged = false, players = [], events = [], sequence = 0, detailed = false, event_log = [], replay_actions = [], replay_sequence = 0, current_time = 0.0) {
