                                ...
                                if (py.truth(((py.equal(action, "quit"))))) {
                                    ...
                                    if (py.truth(((py.equal(action, "switch"))))) {
                                        ...
                                        if (py.truth(((py.equal(action, "dodge"))))) {
                                            ...
                                            if (py.truth(((py.equal(action, "gem"))))) {
                                                try {
                                                    sim.use_purified_gem((tick / 2), i, true);
                                                }
                                                catch (error) {
                                                    fail(error instanceof Error ? error.message : py.str(error));
                                                }
                                            }
                                            else if (py.truth(((py.equal(action, "move"))))) {
